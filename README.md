...
- [Source](https://github.com/michaeljbaumli/working-with-markdown "Working With Markdown Source")
...
![vscode image](https://github.com/michaeljbaumli/working-with-markdown/blob/master/vscode.PNG "Example local image")
